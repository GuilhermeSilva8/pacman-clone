...
class BlinkySpriteSheet {
  ...
  static Future<SpriteAnimation> get idleRight => SpriteAnimation.load(
    ...
    SpriteAnimationData.sequenced(amount: 2,
        ...
        texturePosition: Vector2(120, 80)
    ),
  );
...
class Blinky extends SimpleEnemy with ObjectCollision, AutomaticRandomMovement {

  Blinky(Vector2 position)
      : super(
          position: position,
          size: Vector2(32, 32),
          animation: BlinkySpriteSheet.simpleDirectionAnimation,
          speed: 60
      ) {
          setupCollision(
              CollisionConfig(
