...
class PinkySpriteSheet {
  ...
  static Future<SpriteAnimation> get idleRight => SpriteAnimation.load(
    ...
    SpriteAnimationData.sequenced(amount: 2,
        ...
        texturePosition: Vector2(120, 100)
    ),
  );
  ...
  static Future<SpriteAnimation> get idleLeft => SpriteAnimation.load(
    ...
    SpriteAnimationData.sequenced(amount: 2,
        stepTime: 0.15,
        textureSize: Vector2(18,18),
        texturePosition: Vector2(80, 100)
    ),
  );
  ...
  static Future<SpriteAnimation> get idleDown => SpriteAnimation.load(
    ...
    SpriteAnimationData.sequenced(amount: 2,
        stepTime: 0.15,
        textureSize: Vector2(18,18),
        texturePosition: Vector2(40, 100)
    ),
  );
...
class Pinky extends SimpleEnemy with ObjectCollision, AutomaticRandomMovement {

  Pinky(Vector2 position)
      : super(
      position: position,
      size: Vector2(32, 32),
      animation: PinkySpriteSheet.simpleDirectionAnimation,
      speed: 60
  ) {
    setupCollision(
        CollisionConfig(
